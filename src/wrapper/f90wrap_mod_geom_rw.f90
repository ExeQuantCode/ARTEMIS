...
subroutine f90wrap_geom_rw__change_lattice__binding__basis_type(this, lattice)
    ...
    this_ptr = transfer(this, this_ptr)
    call this_ptr%p%change_lattice(lattice=lattice)
end subroutine f90wrap_geom_rw__change_lattice__binding__basis_type
...
subroutine f90wrap_geom_rw__normalise__binding__basis_type(this, ceil_val, floor_coords, round_coords, &
    ...
    type(basis_type_ptr_type) :: this_ptr
    integer, intent(in), dimension(2) :: this
    real(4), intent(in), optional :: ceil_val
    logical, intent(in), optional :: floor_coords
    logical, intent(in), optional :: round_coords
    real(4), intent(in), optional :: zero_round
    this_ptr = transfer(this, this_ptr)
    call this_ptr%p%normalise(ceil_val=ceil_val, floor_coords=floor_coords, round_coords=round_coords, &
...
subroutine f90wrap_geom_rw__remove_atom__binding__basis_type(this, ispec, iatom)
    ...
    this_ptr = transfer(this, this_ptr)
    call this_ptr%p%remove_atom(ispec=ispec, iatom=iatom)
...
subroutine f90wrap_geom_rw__remove_atoms__binding__basis_type(this, atoms, n0, n1)
    ...
    type(basis_type_ptr_type) :: this_ptr
    integer, intent(in), dimension(2) :: this
    integer, intent(in), dimension(n0,n1) :: atoms
    integer :: n0
    !f2py intent(hide), depend(atoms) :: n0 = shape(atoms,0)
    integer :: n1
    !f2py intent(hide), depend(atoms) :: n1 = shape(atoms,1)
    this_ptr = transfer(this, this_ptr)
    call this_ptr%p%remove_atoms(atoms=atoms)
...
subroutine f90wrap_geom_rw__get__igeom_input(f90wrap_igeom_input)
    ...
    f90wrap_igeom_input = artemis__geom_rw_igeom_input
...
subroutine f90wrap_geom_rw__set__igeom_input(f90wrap_igeom_input)
    ...
    artemis__geom_rw_igeom_input = f90wrap_igeom_input
...
subroutine f90wrap_geom_rw__get__igeom_output(f90wrap_igeom_output)
    ...
    f90wrap_igeom_output = artemis__geom_rw_igeom_output
